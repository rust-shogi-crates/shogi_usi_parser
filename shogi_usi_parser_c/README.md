# Rust shogi crates: USI parser (`cdylib`)
![Rust Version](https://img.shields.io/badge/rustc-1.60+-blue.svg)
[![license](https://img.shields.io/badge/license-MIT-blue.svg)](https://opensource.org/licenses/mit-license.php)

This crate defines C bindings to [shogi_usi_parser](https://github.com/rust-shogi-crates/shogi_usi_parser/tree/main/shogi_usi_parser). A C header file for this crate is placed in `include/` and generated with `make`.
